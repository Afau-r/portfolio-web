  ...
  const projects = [
    {
      ...
      image: "/growth_opportunities.png", // Añade imágenes reales de tus proyectos
    ...
    },
    {
      ...
      // image: "/images/forecasting-project.jpg",
      github: "https://github.com/Afau-r/Projects",
      icon: "📦"
    },
    {
          ...
          >
            ...
            <div className="project-links">
              {project.id === 2 ? (
                ...
                <a href="/Dashboard_de_Bienestar.twbx" download>
                  Descargar Dashboard
                </a>
              ) : (
