  ...
  const projects = [
    {
      ...
      image: "/portfolio-web/growth_opportunities.png", // Añade imágenes reales de tus proyectos
    ...
    },
    {
      ...
      // image: "/portfolio-web/images/forecasting-project.jpg",
      github: "https://github.com/Afau-r/Projects",
      icon: "📦"
    },
    {
      ...
      image: "/portfolio-web/rfm_3d_clusters.png",
      github: "https://github.com/Afau-r/Projects",
      icon: "🛍️"
    },
    {
      ...
      image: "/portfolio-web/dashboard_bienestar.pdf",
      github: "https://github.com/Afau-r/Projects",
      icon: "📊"
    }
  ];
          ...
          >
            ...
            <div className="project-links">
              {project.id === 2 ? (
                ...
                <a href="/portfolio-web/Dashboard_de_Bienestar.twbx" download>
                  Descargar Dashboard
                </a>
              ) : (
